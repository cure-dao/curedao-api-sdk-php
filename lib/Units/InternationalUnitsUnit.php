...
class InternationalUnitsUnit extends BaseUnit {
	const ABBREVIATED_NAME = 'IU';
	const ADVANCED = 1;
	const CATEGORY_ID = 6;
	...
	const NAME = 'International Units';
	const SCALE = 'ratio';
	const SUFFIX = null;
	const SYNONYMS = ['International Units', 'IU', 'International Unit'];
