...
class MillisecondsUnit extends BaseUnit {
	const ABBREVIATED_NAME = 'ms';
	const ADVANCED = 1;
	const CATEGORY_ID = 1;
	...
	const MAXIMUM_VALUE = 864000000;
	public $maximumDailyValue = 60 * 60 * 24 * 1000;
	const MINIMUM_VALUE = 0;
	const NAME = 'Milliseconds';
	const SCALE = 'ratio';
	const SUFFIX = null;
	const SYNONYMS = ['Milliseconds', 'ms', 'Millisecond'];
