...
use CureDAO\Client\UnitCategories\CountUnitCategory;
class EventUnit extends BaseUnit {
	const ABBREVIATED_NAME = 'event';
	const ADVANCED = 1;
	const CATEGORY_ID = 13;
	const CATEGORY_NAME = CountUnitCategory::NAME;
