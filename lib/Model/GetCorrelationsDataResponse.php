...
/**
 * GetCorrelationsDataResponse Class Doc Comment
 *
 */
class GetCorrelationsDataResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetCorrelationsDataResponse';
    ...
    protected static $swaggerTypes = [
        'correlations' => '\CureDAO\Client\Model\Correlation[]',
        'explanation' => '\CureDAO\Client\Model\Explanation',
        'description' => 'string',
        'summary' => 'string',
    ...
    {
        $this->container['correlations'] = isset($data['correlations']) ? $data['correlations'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['correlations'] === null) {
            $invalidProperties[] = "'correlations' can't be null";
        }
    ...
    {
        return $this->container['correlations'];
    }

    /**
     * Sets correlations
     *
     * @param \CureDAO\Client\Model\Correlation[] $correlations correlations
     *
     * @return $this
     */
    public function setCorrelations($correlations)
    {
        $this->container['correlations'] = $correlations;
     ...
     * Gets explanation
     *
     * @return \CureDAO\Client\Model\Explanation
     */
     ...
     * Sets explanation
     *
     * @param \CureDAO\Client\Model\Explanation $explanation explanation
     *
     * @return $this
     */
