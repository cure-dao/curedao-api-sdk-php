...
/**
 * GetTrackingReminderNotificationsResponse Class Doc Comment
 *
 */
class GetTrackingReminderNotificationsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetTrackingReminderNotificationsResponse';
    ...
    protected static $swaggerTypes = [
        'data' => '\CureDAO\Client\Model\TrackingReminderNotification[]',
        'description' => 'string',
        'summary' => 'string',
     ...
     * Sets data
     *
     * @param \CureDAO\Client\Model\TrackingReminderNotification[] $data data
     *
     * @return $this
     */
