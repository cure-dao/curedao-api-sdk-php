...
class Unit implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'conversion_steps' => '\CureDAO\Client\Model\ConversionStep[]',
        'id' => 'int',
        'manual_tracking' => 'int',
        ...
        'minimum_value' => 'int',
        'name' => 'string',
        'unit_category' => '\CureDAO\Client\Model\UnitCategory'
    ];
     ...
     *
     * @return \CureDAO\Client\Model\ConversionStep[]
     */
     ...
     *
     * @param \CureDAO\Client\Model\ConversionStep[] $conversion_steps Conversion steps list
     *
     * @return $this
     */
     ...
     * Sets unit_category
     *
     * @param \CureDAO\Client\Model\UnitCategory $unit_category unit_category
     *
     * @return $this
     */
