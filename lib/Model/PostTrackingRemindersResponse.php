...
/**
 * PostTrackingRemindersResponse Class Doc Comment
 *
 */
class PostTrackingRemindersResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PostTrackingRemindersResponse';
    ...
    protected static $swaggerTypes = [
        'data' => '\CureDAO\Client\Model\PostTrackingRemindersDataResponse',
        'message' => 'string',
        'description' => 'string',
        'summary' => 'string',
     ...
     * Gets data
     *
     * @return \CureDAO\Client\Model\PostTrackingRemindersDataResponse
     */
     ...
     * Sets data
     *
     * @param \CureDAO\Client\Model\PostTrackingRemindersDataResponse $data data
     *
     * @return $this
     */
