...
class Card implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'action_sheet_buttons' => '\CureDAO\Client\Model\Button[]',
        'avatar' => 'string',
        'avatar_circular' => 'string',
        'background_color' => 'string',
        'buttons' => '\CureDAO\Client\Model\Button[]',
        'buttons_secondary' => '\CureDAO\Client\Model\Button[]',
        'content' => 'string',
        'header_title' => 'string',
        'html' => 'string',
        'html_content' => 'string',
        'id' => 'string',
        'image' => 'string',
        'input_fields' => '\CureDAO\Client\Model\InputField[]',
        'ion_icon' => 'string',
        'link' => 'string',
        'parameters' => 'object',
        'related_cards' => '\CureDAO\Client\Model\Card[]',
        'selected_button' => '\CureDAO\Client\Model\Button',
        'sharing_body' => 'string',
        'sharing_buttons' => '\CureDAO\Client\Model\Button[]',
     ...
     *
     * @return \CureDAO\Client\Model\Button[]
     */
     ...
     *
     * @param \CureDAO\Client\Model\Button[] $action_sheet_buttons action_sheet_buttons
     *
     * @return $this
     */
     ...
     * Sets buttons
     *
     * @param \CureDAO\Client\Model\Button[] $buttons buttons
     *
     * @return $this
     */
     ...
     *
     * @param \CureDAO\Client\Model\Button[] $buttons_secondary buttons_secondary
     *
     * @return $this
     */
     ...
     * Gets input_fields
     *
     * @return \CureDAO\Client\Model\InputField[]
     */
     ...
     * Sets input_fields
     *
     * @param \CureDAO\Client\Model\InputField[] $input_fields input_fields
     *
     * @return $this
     */
     ...
     * Sets related_cards
     *
     * @param \CureDAO\Client\Model\Card[] $related_cards related_cards
     *
     * @return $this
     */
     ...
     *
     * @param \CureDAO\Client\Model\Button $selected_button Button that the user clicked and the provided function parameters
     *
     * @return $this
     */
     ...
     *
     * @param \CureDAO\Client\Model\Button[] $sharing_buttons sharing_buttons
     *
     * @return $this
     */
