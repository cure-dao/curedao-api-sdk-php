...
/**
 * GetConnectorsResponse Class Doc Comment
 *
 */
class GetConnectorsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetConnectorsResponse';
    ...
    protected static $swaggerTypes = [
        'connectors' => '\CureDAO\Client\Model\DataSource[]',
        'description' => 'string',
        'summary' => 'string',
     ...
     * Sets connectors
     *
     * @param \CureDAO\Client\Model\DataSource[] $connectors connectors
     *
     * @return $this
     */
