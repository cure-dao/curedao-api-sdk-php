...
/**
 * AppSettingsResponse Class Doc Comment
 *
 */
class AppSettingsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AppSettingsResponse';
    ...
    protected static $swaggerTypes = [
        'app_settings' => '\CureDAO\Client\Model\AppSettings',
        'description' => 'string',
        'summary' => 'string',
    ...
    {
        $this->container['app_settings'] = isset($data['app_settings']) ? $data['app_settings'] : null;
     ...
     * Sets app_settings
     *
     * @param \CureDAO\Client\Model\AppSettings $app_settings app_settings
     *
     * @return $this
     */
    public function setAppSettings($app_settings)
    {
        $this->container['app_settings'] = $app_settings;
