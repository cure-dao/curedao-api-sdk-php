...
/**
 * UserVariableDelete Class Doc Comment
 *
 */
class UserVariableDelete implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserVariableDelete';
     ...
     * Sets variable_id
     *
     * @param int $variable_id Id of the variable whose measurements should be deleted
     *
     * @return $this
     */
