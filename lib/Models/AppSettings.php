...
class AppSettings implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'collaborators' => '\CureDAO\Client\Models\User[]',
        'created_at' => 'string',
        'user_id' => 'int',
     ...
     * Sets collaborators
     *
     * @param \CureDAO\Client\Models\User[] $collaborators What do you expect?
     *
     * @return $this
     */
     ...
     * Sets users
     *
     * @param \CureDAO\Client\Models\User[] $users What do you expect?
     *
     * @return $this
     */
