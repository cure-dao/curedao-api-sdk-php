...
class GetCorrelationsResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'data' => '\CureDAO\Client\Models\GetCorrelationsDataResponse',
        'description' => 'string',
        'summary' => 'string',
        'avatar' => 'string',
     ...
     * Gets data
     *
     * @return \CureDAO\Client\Models\GetCorrelationsDataResponse
     */
     ...
     * Sets data
     *
     * @param \CureDAO\Client\Models\GetCorrelationsDataResponse $data data
     *
     * @return $this
     */
