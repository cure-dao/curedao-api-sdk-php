...
/**
 * GetTrackingReminderNotificationsResponse Class 
 */
class GetTrackingReminderNotificationsResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'data' => '\CureDAO\Client\Models\TrackingReminderNotification[]',
        'description' => 'string',
        'summary' => 'string',
     ...
     * Sets data
     *
     * @param \CureDAO\Client\Models\TrackingReminderNotification[] $data data
     *
     * @return $this
     */
