...
class FacebookPostsMadeCommonVariable extends BaseVariable {
	...
	public const NAME = 'Facebook Posts Made';
	public const ONSET_DELAY = 0;
    public const OUTCOME = true;
	public const SYNONYMS = ['Facebook Posts Made'];
