<?php
namespace CureDAO\Client\Variables\SocialInteractionsCommonVariables;
use CureDAO\Client\Properties\Base\BaseFillingTypeProperty;
use CureDAO\Client\DataSources\Connectors\FacebookConnector;
use CureDAO\Client\Variables\BaseVariable;
class LikesOnYourFacebookPostsCommonVariable extends BaseVariable {
	...
	public const NAME = 'Likes On Your Facebook Posts';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const SYNONYMS = ['Likes On Your Facebook Posts', 'Likes On Your Facebook Post'];
