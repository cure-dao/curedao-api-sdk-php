...
class FacebookPagesLikedCommonVariable extends BaseVariable {
	...
	public const NAME = 'Facebook Pages Liked';
	public const ONSET_DELAY = 0;
    public const OUTCOME = true;
	public const SYNONYMS = ['Facebook Pages Liked'];
