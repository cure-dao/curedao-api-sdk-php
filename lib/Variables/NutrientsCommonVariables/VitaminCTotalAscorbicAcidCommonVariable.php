...
class VitaminCTotalAscorbicAcidCommonVariable extends BaseVariable {
	...
	public const ID = 5401611;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/41MkELAAXdL._SL160_.jpg';
	...
	public const NAME = 'Vitamin C, Total Ascorbic Acid';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Vitamin C', 'Vitamin C, Total Ascorbic Acid'];
