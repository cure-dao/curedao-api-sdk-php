...
class FolateFoodCommonVariable extends BaseVariable {
	...
	public const ID = 5401681;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/515W-KwRrEL._SL160_.jpg';
	...
	public const NAME = 'Folate, Food';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Folate', 'Folate, Food'];
