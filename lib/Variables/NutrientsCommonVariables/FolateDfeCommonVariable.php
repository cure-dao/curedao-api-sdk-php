...
class FolateDfeCommonVariable extends BaseVariable {
	...
	public const ID = 5401691;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/41g4NPdViSL._SL160_.jpg';
	...
	public const NAME = 'Folate, DFE';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Folate', 'Folate, DFE'];
