...
class VitaminARaeCommonVariable extends BaseVariable {
	...
	public const NAME = 'Vitamin A, RAE';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Vitamin A', 'Vitamin A, RAE'];
