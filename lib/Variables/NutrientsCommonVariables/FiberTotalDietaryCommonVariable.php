...
class FiberTotalDietaryCommonVariable extends BaseVariable {
	...
	public const ID = 5401311;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/41Xx76df9sL._SL160_.jpg';
	...
	public const NAME = 'Fiber, Total Dietary';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Fiber', 'Fiber, Total Dietary'];
