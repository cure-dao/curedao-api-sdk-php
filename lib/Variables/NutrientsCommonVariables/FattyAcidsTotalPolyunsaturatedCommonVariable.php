...
class FattyAcidsTotalPolyunsaturatedCommonVariable extends BaseVariable {
	...
	public const ID = 5402171;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/51SgvmN6VcL._SL160_.jpg';
	...
	public const NAME = 'Fatty Acids, Total Polyunsaturated';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Fatty Acids', 'Fatty Acids, Total Polyunsaturated', 'Fatty Acid'];
