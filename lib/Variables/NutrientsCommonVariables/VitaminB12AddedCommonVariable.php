...
class VitaminB12AddedCommonVariable extends BaseVariable {
	...
	public const ID = 5401871;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/51a7yQBNcUL._SL160_.jpg';
	...
	public const NAME = 'Vitamin B-12, Added';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Vitamin B-12', 'Vitamin B-12, Added'];
