...
class FattyAcidsTotalSaturatedCommonVariable extends BaseVariable {
	...
	public const ID = 5401891;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/418OHPDpqKL._SL160_.jpg';
	...
	public const NAME = 'Fatty Acids, Total Saturated';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Fatty Acids', 'Fatty Acids, Total Saturated', 'Fatty Acid'];
