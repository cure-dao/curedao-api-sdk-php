...
class VitaminEAddedCommonVariable extends BaseVariable {
	...
	public const NAME = 'Vitamin E, Added';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Vitamin E', 'Vitamin E, Added'];
