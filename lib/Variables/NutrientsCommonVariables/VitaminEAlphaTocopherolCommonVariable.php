...
class VitaminEAlphaTocopherolCommonVariable extends BaseVariable {
	...
	public const NAME = 'Vitamin E (alpha-tocopherol)';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Vitamin E', 'alpha-tocopherol'];
