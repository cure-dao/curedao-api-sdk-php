...
class VitaminKPhylloquinoneCommonVariable extends BaseVariable {
	...
	public const ID = 5401671;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/51o1ZEQ8TRL._SL160_.jpg';
	...
	public const NAME = 'Vitamin K (phylloquinone)';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Vitamin K', 'phylloquinone'];
