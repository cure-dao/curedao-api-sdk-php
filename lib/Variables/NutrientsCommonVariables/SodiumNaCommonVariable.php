...
class SodiumNaCommonVariable extends BaseVariable {
	...
	public const ID = 5401371;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/51oEKjHYBPL._SL160_.jpg';
	...
	public const NAME = 'Sodium, Na';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Sodium', 'Sodium, Na'];
