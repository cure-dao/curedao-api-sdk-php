...
class LuteinZeaxanthinCommonVariable extends BaseVariable {
	...
	public const NAME = 'Lutein + Zeaxanthin';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Lutein + Zeaxanthin'];
