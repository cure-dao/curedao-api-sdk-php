...
class CryptoxanthinBetaCommonVariable extends BaseVariable {
	...
	public const ID = 5401521;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/414WTDpBTPL._SL160_.jpg';
	...
	public const NAME = 'Cryptoxanthin, Beta';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Cryptoxanthin', 'Cryptoxanthin, Beta', 'Cryptoxanthin, Betum'];
