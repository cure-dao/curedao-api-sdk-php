...
class TheobromineCommonVariable extends BaseVariable {
	...
	public const ID = 5401281;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/41q2cfdMvOL._SL160_.jpg';
	...
	public const NAME = 'Theobromine';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Theobromine'];
