...
class IronFeCommonVariable extends BaseVariable {
	...
	public const ID = 5401331;
	public const IMAGE_URL = 'https://images-na.ssl-images-amazon.com/images/I/51Dk97jkA7L._SL160_.jpg';
	...
	public const NAME = 'Iron, Fe';
	public const ONSET_DELAY = 1800;
	public const OUTCOME = false;
	public const SYNONYMS = ['Iron', 'Iron, Fe'];
