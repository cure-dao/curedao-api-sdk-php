...
class DailyHighOutdoorTemperatureVariable extends BaseVariable {
	...
	public const MAXIMUM_ALLOWED_VALUE = AverageDailyOutdoorTemperatureVariable::MAXIMUM_ALLOWED_VALUE;
	public const MINIMUM_ALLOWED_SECONDS_BETWEEN_MEASUREMENTS = 86400;
	public const MINIMUM_ALLOWED_VALUE = AverageDailyOutdoorTemperatureVariable::MINIMUM_ALLOWED_VALUE;
