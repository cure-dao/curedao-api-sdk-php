...
class DailyStepCountCommonVariable extends BaseVariable {
	...
	public const NAME = 'Daily Step Count';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const SYNONYMS = ['Steps', 'Daily Step', 'Daily Step Count', 'Step'];
