...
class DailyHighOutdoorTemperatureCommonVariable extends BaseVariable {
	...
	public const ID = 6038777;
	public const IMAGE_URL = null;
	public const INFORMATIONAL_URL = null;
	public const MANUAL_TRACKING = false;
	public const MAXIMUM_ALLOWED_VALUE = AverageDailyOutdoorTemperatureCommonVariable::MAXIMUM_ALLOWED_VALUE;
	public const MINIMUM_ALLOWED_SECONDS_BETWEEN_MEASUREMENTS = 86400;
	public const MINIMUM_ALLOWED_VALUE = AverageDailyOutdoorTemperatureCommonVariable::MINIMUM_ALLOWED_VALUE;
	public const NAME = 'Daily High Outdoor Temperature';
	public const ONSET_DELAY = 0;
	public const OUTCOME = false;
	public const SYNONYMS = ['Daily High Outdoor', 'Daily High Outdoor Temperature'];
