...
class AirQualityIndexCommonVariable extends BaseVariable {
	public const COMMON_ALIAS = null;
	public const DEFAULT_UNIT_ID = IndexUnit::ID;
	public const DESCRIPTION = null;
	public const DURATION_OF_ACTION = 604800;
	public const FILLING_TYPE = BaseFillingTypeProperty::FILLING_TYPE_NONE;
	public const ID = 5974683;
	public const IMAGE_URL = ImageUrls::AGRICULTURE_FACTORY;
	...
	public const NAME = 'Air Quality Index';
	public const ONSET_DELAY = 0;
	public const OUTCOME = false;
	public const SYNONYMS = ['Air Quality Index', 'Air Quality'];
