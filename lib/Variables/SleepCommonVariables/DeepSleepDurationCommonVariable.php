<?php
namespace CureDAO\Client\Variables\SleepCommonVariables;
use CureDAO\Client\Properties\Base\BaseFillingTypeProperty;
use CureDAO\Client\Properties\Base\BaseValenceProperty;
use CureDAO\Client\Variables\BaseVariable;
class DeepSleepDurationCommonVariable extends BaseVariable {
	...
	public const MINIMUM_ALLOWED_VALUE = 0;  // I took a nap and it was 0 one time
	public const NAME = 'Deep Sleep Duration';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const SYNONYMS = ['Deep Sleep Duration'];
