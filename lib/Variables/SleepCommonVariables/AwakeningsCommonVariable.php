...
class AwakeningsCommonVariable extends QMCommonVariable {
    ...
    public const NAME = 'Awakenings';
    public const ONSET_DELAY = 0;
    public const OUTCOME = true;
    public const SYNONYMS = ['Awakenings', 'Awakening'];
    public const VALENCE = BaseValenceProperty::VALENCE_NEGATIVE;
    public const VARIABLE_CATEGORY_ID = SleepVariableCategory::ID;
