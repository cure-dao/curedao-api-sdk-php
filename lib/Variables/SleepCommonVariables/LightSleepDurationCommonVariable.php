...
class LightSleepDurationCommonVariable extends BaseVariable {
	...
	public const NAME = 'Light Sleep Duration';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const SYNONYMS = ['Light Sleep'];
