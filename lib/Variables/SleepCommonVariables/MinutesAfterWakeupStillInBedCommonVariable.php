...
class MinutesAfterWakeupStillInBedCommonVariable extends BaseVariable {
	...
	public const NAME = 'Minutes After Wakeup Still In Bed';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const SYNONYMS = ['Minutes After Wakeup Still In Bed'];
