...
class ModeratelyProductiveScoreCommonVariable extends BaseVariable {
	...
	public const NAME = 'Moderately Productive Score';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const SYNONYMS = ['Moderately Productive Score'];
