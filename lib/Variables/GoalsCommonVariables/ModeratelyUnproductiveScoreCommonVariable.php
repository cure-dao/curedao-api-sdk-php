...
class ModeratelyUnproductiveScoreCommonVariable extends BaseVariable {
	...
	public const NAME = 'Moderately Unproductive Score';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const SYNONYMS = ['Moderately Unproductive Score'];
