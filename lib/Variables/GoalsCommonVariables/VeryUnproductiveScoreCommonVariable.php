...
class VeryUnproductiveScoreCommonVariable extends QMCommonVariable {
	...
	public const NAME = 'Very Unproductive Score';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const SYNONYMS = ['Very Unproductive Score'];
