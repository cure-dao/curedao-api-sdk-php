...
class ProductivityPulseFromRescuetimeCommonVariable extends BaseVariable {
	...
	public const NAME = 'Productivity Pulse From Rescuetime';
	public const ONSET_DELAY = 0;
	public const OUTCOME = true;
	public const SYNONYMS = ['Productivity Pulse From Rescuetime'];
