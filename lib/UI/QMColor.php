<?php
namespace CureDAO\Client\UI;
use CureDAO\Client\Traits\ConstantSearch;
class QMColor {
	use ConstantSearch;
	...
	public const HEX_TO_STRING = [
		...
		self::HEX_FUCHSIA => self::STRING_RED,
		...
		self::HEX_GOOGLE_RED => self::STRING_RED,
		self::HEX_GOOGLE_BLUE => self::STRING_BLUE,
		self::HEX_GOOGLE_GREEN => self::STRING_GREEN,
		self::HEX_GOOGLE_PLUS_RED => self::STRING_RED,
		self::HEX_GOOGLE_YELLOW => self::STRING_YELLOW,
	...
	public static function toGradient(string $color): array{
		...
		if(!isset(self::STRING_TO_GRADIENT[$color])){
			le("Please define STRING_TO_GRADIENT for $color in " . static::class);
		}
	...
	public static function toHex(string $colorStr): string{
		...
		if(!isset(self::STRING_TO_HEX[$colorStr])){
			le("Please set STRING_TO_HEX for $colorStr");
		}
