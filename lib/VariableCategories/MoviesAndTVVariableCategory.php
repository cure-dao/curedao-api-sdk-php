...
class MoviesAndTVVariableCategory extends BaseVariableCategory {
	...
	const FONT_AWESOME = FontAwesome::TV_SOLID;
	const ID = 42;
    const IMAGE_URL = 'https://static.quantimo.do/img/variable_categories/retro_tv-96.png';
	const ION_ICON = 'ion-social-youtube';
	...
	const MORE_INFO = "Movies and TV shows watched. ";
	const NAME = 'Movies and TV';
	const ONSET_DELAY = 0;
	const OUTCOME = false;
	const PNG_PATH = 'img/variable_categories/movies-and-tv.png';
    const PNG_URL = 'https://static.quantimo.do/img/variable_categories/movies-and-tv.png';
	const PREDICTOR = true;
	const PUBLIC = true;
	const SETUP_QUESTION = null;
	const STUDY_IMAGE_FILE_NAME = null;
	const SUFFIX = null;
	const SVG_PATH = 'img/variable_categories/movies-and-tv.svg';
    const SVG_URL = 'https://static.quantimo.do/img/variable_categories/movies-and-tv.svg';
	const SYNONYMS = ['Movies and TV'];
	const VALENCE = null;
	const VARIABLE_CATEGORY_NAME_SINGULAR = 'Movies and TV';
