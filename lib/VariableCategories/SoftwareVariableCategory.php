...
class SoftwareVariableCategory extends BaseVariableCategory {
	...
	const FONT_AWESOME = FontAwesome::LAPTOP_CODE_SOLID;
	const ID = 20;
	...
	const MORE_INFO = "Record time spend using specific software or websites. ";
	const NAME = 'Software';
	const ONSET_DELAY = 0;
	const OUTCOME = false;
	...
	const SYNONYMS = ['Software & Mobile Apps', 'App', 'Software', 'Software & Mobile App', "Software Usage"];
	const VALENCE = null;
	const VARIABLE_CATEGORY_NAME_SINGULAR = 'Software';
