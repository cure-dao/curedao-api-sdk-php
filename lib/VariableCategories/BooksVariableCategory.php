...
class BooksVariableCategory extends BaseVariableCategory {
	const AMAZON_PRODUCT_CATEGORY = 'Books';
	const BORING = true;
	...
	const FONT_AWESOME = FontAwesome::BOOK_SOLID;
	const ID = 19;
    const IMAGE_URL = 'https://static.quantimo.do/img/variable_categories/books-96.png';
	const ION_ICON = 'ion-ios-book';
	...
	const MORE_INFO = "Record your books read so we can see which ones actually work. ";
	const NAME = 'Books';
	const ONSET_DELAY = 0;
	const OUTCOME = false;
	const PNG_PATH = 'img/variable_categories/books.png';
    const PNG_URL = 'https://static.quantimo.do/img/variable_categories/books.png';
	const PREDICTOR = true;
	const PUBLIC = true;
	const SETUP_QUESTION = null;
	const STUDY_IMAGE_FILE_NAME = null;
	const SUFFIX = null;
	const SVG_PATH = 'img/variable_categories/books.svg';
    const SVG_URL = 'https://static.quantimo.do/img/variable_categories/books.svg';
	const SYNONYMS = ['Books', 'Book'];
	const VALENCE = null;
	const VARIABLE_CATEGORY_NAME_SINGULAR = 'Book';
	...
	public function indexVariablesQB(): \Illuminate\Database\Eloquent\Builder{
        return $this->getAllPublicVariablesQB();
    }
}
