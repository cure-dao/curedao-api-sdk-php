...
class VitalSignsVariableCategory extends BaseVariableCategory {
	...
	const HELP_TEXT = 'What vital sign do you want to record?';
	const FONT_AWESOME = FontAwesome::HEARTBEAT_SOLID;
	const ID = 8;
    const IMAGE_URL = 'https://static.quantimo.do/img/variable_categories/heart_monitor-96.png';
	const ION_ICON = 'ion-ios-pulse';
	const MANUAL_TRACKING = null; // Leave null so it's set at the variable level
	const MAXIMUM_ALLOWED_VALUE = null;
	const MEASUREMENT_SYNONYM_SINGULAR_LOWERCASE = 'measurement';
	const MINIMUM_ALLOWED_SECONDS_BETWEEN_MEASUREMENTS = null;
	const MINIMUM_ALLOWED_VALUE = null;
	const MORE_INFO = "Your vital signs show how well your body is functioning. They include blood pressure, heart rate, respiratory rate (or pulse), and temperature.";
	const NAME = 'Vital Signs';
	const ONSET_DELAY = 0;
	const OUTCOME = true;
	const PNG_PATH = 'img/variable_categories/vital-signs.png';
    const PNG_URL = 'https://static.quantimo.do/img/variable_categories/vital-signs.png';
	const PREDICTOR = true;
	const PUBLIC = true;
	const SETUP_QUESTION = null;
	const STUDY_IMAGE_FILE_NAME = null;
	const SUFFIX = null;
	const SVG_PATH = 'img/variable_categories/vital-signs.svg';
    const SVG_URL = 'https://static.quantimo.do/img/variable_categories/vital-signs.svg';
	const SYNONYMS = ['Vital Signs', 'Vital Sign'];
	const VALENCE = null;
	const VARIABLE_CATEGORY_NAME = 'Vital Signs';
	const VARIABLE_CATEGORY_NAME_SINGULAR = 'Vital Sign';
