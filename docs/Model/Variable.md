...
**charts** | [**\CureDAO\Client\Model\VariableCharts**](VariableCharts.md) |  | [optional] 
...
**common_tagged_variables** | [**\CureDAO\Client\Model\Variable[]**](Variable.md) |  | [optional] 
**common_tag_variables** | [**\CureDAO\Client\Model\Variable[]**](Variable.md) |  | [optional] 
...
**data_sources** | [**\CureDAO\Client\Model\DataSource[]**](DataSource.md) | These are sources of measurements for this variable | [optional] 
...
**parent_common_tag_variables** | [**\CureDAO\Client\Model\Variable[]**](Variable.md) | Commonly defined for all users.  An example of a parent category variable would be Fruit when tagged with the child sub-type variables Apple.  Child variable (Apple) measurements will be included when the parent category (Fruit) is analyzed.  This allows us to see how Fruit consumption might be affecting without having to record both Fruit and Apple intake. | [optional] 
**parent_user_tag_variables** | [**\CureDAO\Client\Model\Variable[]**](Variable.md) | User-defined. An example of a parent category variable would be Fruit when tagged with the child sub-type variables Apple.  Child variable (Apple) measurements will be included when the parent category (Fruit) is analyzed.  This allows us to see how Fruit consumption might be affecting without having to record both Fruit and Apple intake. | [optional] 
...
**tracking_instructions_card** | [**\CureDAO\Client\Model\Card**](Card.md) | Instructions for tracking with buttons and images | [optional] 
**unit** | [**\CureDAO\Client\Model\Unit**](Unit.md) |  | [optional] 
...
**user_id** | **int** | User ID | 
**user_tagged_variables** | [**\CureDAO\Client\Model\Variable[]**](Variable.md) |  | [optional] 
**user_tag_variables** | [**\CureDAO\Client\Model\Variable[]**](Variable.md) |  | [optional] 
...
**variable_category** | [**\CureDAO\Client\Model\VariableCategory**](VariableCategory.md) |  | [optional] 
**joined_variables** | [**\CureDAO\Client\Model\Variable[]**](Variable.md) | Array of Variables that are joined with this Variable | [optional] 
